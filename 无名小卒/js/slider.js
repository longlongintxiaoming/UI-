(function() {
    ...
    var textOptions = {
        ...
        translate: function() {
            if (windowWidth > 1120) return {translateX: 500, translateY: 270};
            if (windowWidth > 720) return {translateX: 50, translateY: 270};
            return {translateX: 25, translateY: 150};
        }
    };
    ...
    var numberOptions = {
        ...
        ty: function() { return Pieces.random(-200, 200); },
        translate: function() {
            if (windowWidth > 1120) return {translateX: -550, translateY: -270};
            if (windowWidth > 720) return {translateX: -360, translateY: -370};
            return {translateX: -200, translateY: -150};
        }
    };
